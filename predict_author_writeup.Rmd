...
[^2]: Full list of packages used can be found in the Appendix




[4]: That's the maximum value that allows us to achieve a balance between prediction power and processing capabilities.
